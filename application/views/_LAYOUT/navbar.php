...
<div class="container">
    ...
    <div class="main-sidebar col-lg-3 col-md-3">
        ...
        <section class="sidebar-service solid-border-box">
            <ul class="sidebar-menu">
                <a href="#">
                    <li class="solid-border-bottom"><i class="glyphicon glyphicon-gift"></i><span>이벤트</span></li>
                </a>
                <a href="#">
                    <li class="solid-border-bottom"><i class="glyphicon glyphicon-gift"></i><span>고객센터</span></li>
                </a>
                <a href="<?= site_url('/home/contact');?>">
                    <li class="solid-border-bottom"><i class="glyphicon glyphicon-gift"></i><span>Contact</span></li>
                </a>
            </ul>
        </section>
    </div>
